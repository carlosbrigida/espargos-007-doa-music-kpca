...
def evaluate_scenario(scenario_name, filename):
    ...
    clutter_file = PROJECT_DIR / "clutter_channel_estimates" / f"{filename}.npy"
    ...
    clusters, unique_macs = cluster_cache_data(
        csi=csi,
        mac=mac,
        pos=pos,
    ...
    for cluster in clusters:
        ...
        R_all = covariance_per_array_luis_cluster(csi_by_transmitter_noclutter)
...
def main():
    print("=" * 80)
    print("LUIS uROOT-MUSIC BASELINE - CLUSTERS - WITH CRAP")
    print("=" * 80)
    ...
    output = {
        "experiment": "luis_uroot_music_cluster_baseline_with_crap",
        "cluster_interval_seconds": CLUSTER_INTERVAL_SECONDS,
        "crap": True,
    ...
    output_file = (
        ...
        / "outputs"
        / "metrics"
        / "luis_uroot_music_cluster_baseline_with_crap.json"
    )
